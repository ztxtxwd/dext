...
import { DebugDextOAuthClientProvider, discoverScopes } from "./auth";
import {
...
export interface StateMachineContext {
  ...
  serverUrl: string;
  provider: DebugDextOAuthClientProvider;
...
export class OAuthStateMachine {
  ...
  async executeStep(state: AuthDebuggerState): Promise<void> {
    const provider = new DebugDextOAuthClientProvider(this.serverUrl);
