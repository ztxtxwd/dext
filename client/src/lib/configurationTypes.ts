...
/**
 * Configuration interface for the MCP Dext, including settings for the MCP Client,
 * Proxy Server, and Dext UI/UX.
 *
 ...
 */
export type DextConfig = {
  /**
   * Client-side timeout in milliseconds. The Dext will cancel the request if no response
