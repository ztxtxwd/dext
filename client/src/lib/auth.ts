...
export class DextOAuthClientProvider implements OAuthClientProvider {
  constructor(
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      ...
      response_types: ["code"],
      client_name: "MCP Dext",
      client_uri: "https://github.com/ztxtxwd/dext",
      scope: this.scope ?? "",
    };
  }
...
// display in debug UI.
export class DebugDextOAuthClientProvider extends DextOAuthClientProvider {
