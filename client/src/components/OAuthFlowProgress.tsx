...
import { DebugDextOAuthClientProvider } from "@/lib/auth";
...
export const OAuthFlowProgress = ({
  ...
  const provider = useMemo(
    () => new DebugDextOAuthClientProvider(serverUrl),
    [serverUrl],
  );
          ...
          <div className="mt-3">
            ...
            <div className="flex gap-2">
              <input
                ...
                className={`flex h-9 w-full rounded-md border bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${
