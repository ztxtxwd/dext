...
describe("Sidebar", () => {
  ...
  describe("Command and arguments", () => {
    it("should trim whitespace from command input on blur-sm", () => {
    ...
    it("should handle whitespace-only command input on blur-sm", () => {
      const setCommand = jest.fn();
  ...
  describe("Configuration", () => {
    ...
    it("should update MCP server request timeout", () => {
      ...
      renderSidebar({ config: DEFAULT_DEXT_CONFIG, setConfig });
    ...
    it("should maintain configuration state after multiple updates", () => {
      ...
      const updatedConfig = setConfig.mock.calls[0][0] as DextConfig;
